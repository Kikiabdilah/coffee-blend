...
<?php
$product = $conn->query("SELECT * FROM products WHERE type='drink' ");
$product->execute();
	...
	<div class="container">
		...
		<div class="row">
			<?php foreach ($allproducts as $product): ?>
				<div class="col-md-3">
					<div class="menu-entry">
						<a target="_blank" href="images/<?php echo $product->image; ?>" class="img"
							style="background-image: url(images/<?php echo $product->image; ?>);"></a>
