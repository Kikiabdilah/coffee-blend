		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<?php foreach ($alldesserts as $desserts): ?>
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img" style="background-image: url(images/<?php echo $desserts->image; ?>);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3><span><?php echo $desserts->name; ?></span></h3>
								<span class="price">$<?php echo $desserts->price; ?></span>
							</div>
							<div class="d-block">
			...
			<div class="col-md-6">
				...
				<?php foreach ($alldrinks as $drinks): ?>
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img" style="background-image: url(images/<?php echo $drinks->image ?>);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3><span><?php echo $drinks->name ?></span></h3>
								<span class="price">$<?php echo $drinks->price ?></span>
							</div>
							<div class="d-block">
								...
								<div class="row">
									<?php foreach ($alldrinks as $drinks): ?>
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="products/product-single.php?id=<?php echo $drinks->id; ?>"
													class="menu-img img mb-4"
													style="background-image: url(images/<?php echo $drinks->image; ?>);"></a>
												<div class="text">
													<h3><a
															href="products/product-single.php?id=<?php echo $desserts->id; ?>"><?php echo $drinks->name; ?></a>
													</h3>
													<p><?php echo $drinks->description; ?></p>
													<p class="price"><span>$<?php echo $drinks->price; ?></span></p>
													<p><a href="products/product-single.php?id=<?php echo $drinks->id; ?>"
							...
							<div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
								<div class="row">
									<?php foreach ($alldesserts as $desserts): ?>
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="products/product-single.php?id=<?php echo $desserts->id; ?>"
													class="menu-img img mb-4"
													style="background-image: url(images/<?php echo $desserts->image; ?>);"></a>
												<div class="text">
													<h3><a
															href="products/product-single.php?id=<?php echo $desserts->id; ?>"><?php echo $desserts->name; ?></a>
													</h3>
													<p><?php echo $desserts->description; ?></p>
													<p class="price"><span>$<?php echo $desserts->price; ?></span></p>
													<p><a href="products/product-single.php?id=<?php echo $desserts->id; ?>"
															class="btn btn-primary btn-outline-primary">Show</a></p>
												</div>
											</div>
										</div>
